...
def build_bn(width, height, n_classes, weights_path=None, train=False):
    ...
    # (1/2)
    y = Lambda(lambda x: K.resize_images(x, 0.5, 0.5, data_format='channels_last'), name='data_sub2')(x)
    ...
    # (1/4)
    y_ = Lambda(lambda x: K.resize_images(x, 0.5, 0.5, data_format='channels_last'), name='conv3_1_sub4')(z)
    ...
    aux_2 = Lambda(lambda x: K.resize_images(x, 2, 2, data_format='channels_last'), name='sub24_sum_interp')(y)
    ...
    y = Lambda(lambda x: K.resize_images(x, 2, 2, data_format='channels_last'), name='sub12_sum_interp')(y)
